...
import { indentLine,indentLines } from "../input/indent.js"
...
export default function(CodeMirror) {
  ...
  CodeMirror.prototype = {
    ...
    indentLines: methodOp(function(n,count, offset, dir, aggressive) {
      if (typeof dir != "string" && typeof dir != "number") {
        if (dir == null) dir = this.options.smartIndent ? "smart" : "prev"
        else dir = dir ? "add" : "subtract"
      }
      if (isLine(this.doc, n)) indentLines(this, n,count,offset, dir, aggressive)
    }),
